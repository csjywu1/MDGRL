...
public class GlobalTimer {
    ...
    private static long applStartTime = 0;
    ...
    public static boolean stopAppl() {
        if(Settings.APPL_TIME == 0)
            return false;
        return ((double) (System.currentTimeMillis() - specStartTime) / 1000d) > Settings.APPL_TIME;
    }
    ...
    public static void setApplStartTime(long insStartTime) {
        GlobalTimer.applStartTime = insStartTime;
    }
...
//        System.out.println(Settings.GEN_TIME);
//        System.out.println((double) (System.currentTimeMillis() - genStartTime) / 1000d);
